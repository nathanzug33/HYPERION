...
import { CIVILITE_LABELS, SUIVI_TYPE } from "@/lib/constants";
import { quickUpdateConsultantAction } from "./actions";
import { createSuiviAction } from "./[id]/suivi-actions";
...
export default function ConsultantQuickEditPopover({ consultant }: { consultant: Consultant }) {
        ...
        <div className="fixed bottom-4 right-4 z-50 w-[min(92vw,380px)] max-h-[80vh] overflow-y-auto card p-4 shadow-xl text-left">
          <div className="mb-3 flex items-center justify-between gap-2">
            <h2 className="text-sm font-semibold text-brand-ink">
              Modifier rapidement — {consultant.prenom} {consultant.nom}
            </h2>
            <button
              type="button"
          ...
          <form
            action={quickUpdateConsultantAction}
          ...
          >
            ...
            <div>
              ...
              <select
                name="civilite"
                defaultValue={consultant.civilite ?? ""}
            ...
            <div className="grid grid-cols-2 gap-2">
              <div>
                ...
                <input
                  name="prenom"
                  defaultValue={consultant.prenom}
                  required
                  className="input text-xs"
                />
              </div>
              <div>
                ...
                <input name="nom" defaultValue={consultant.nom} required className="input text-xs" />
              </div>
            </div>
            <div>
            ...
            <div>
              ...
              <input
                name="telephone"
                defaultValue={consultant.telephone ?? ""}
                className="input text-xs"
              />
            </div>
